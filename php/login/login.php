...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($alreadyVerified) {
        ...
        logActivity($pdo, $user['id'], $user['name'], 'Login', 'System', "Daily verification bypass - already verified", $_SERVER['REMOTE_ADDR'], $_SERVER['HTTP_USER_AGENT']);
    ...
    if ($emailResult['success']) {
        logActivity($pdo, $user['id'], $user['name'], 'Login', 'System', "MFA code sent to {$user['email']}", $_SERVER['REMOTE_ADDR'], $_SERVER['HTTP_USER_AGENT']);
    } else {
        logActivity($pdo, $user['id'], $user['name'], 'Login', 'System', "MFA code generated but email failed: " . $emailResult['error'], $_SERVER['REMOTE_ADDR'], $_SERVER['HTTP_USER_AGENT']);
