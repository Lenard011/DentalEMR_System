...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <form action="">
            ...
            <main class="p-3 md:ml-64 h-auto pt-20" id="patienttreatmentvital"
                ...
                <section class="bg-white dark:bg-gray-900 p-3 rounded-lg mb-3 mt-3">
                    ...
                    <!-- Medical History -->
                    <div class="grid mb-4 w-full relative gap-2 ">
                        <p class="text-14 relative flex font-semibold text-gray-900 dark:text-white">Medical History
                        </p>
                        <div class="w-full">
                            <div class="flex w-full relative  items-center mb-1">
                            ...
                            <div class="flex items-center w-full mb-1">
                                <input type="checkbox" name="prev_hospitalization_flag" value="1"
                                    ...
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <div class="grid grid-cols-2 w-full items-center gap-1">
                                    <label for="default-checkbox"
                                        class="ms-2  w-full text-sm font-medium text-gray-900 dark:text-gray-300">History
                            ...
                            <div class="flex flex-col w-full ml-4">
                                <label for="default-checkbox"
                                    ...
                                    Medical </label>
                                <div class="ms-4 flex flex-row w-full gap-1">
                        ...
                        <div class="flex w-full  items-center mb-1">
                            ...
                            <div class="flex flex-row w-full items-center gap-">
                                <label for="default-checkbox"
                                    class="ms-2  text-sm font-medium text-gray-900 dark:text-gray-300">Others
                                    (Please specify)</label>
                    ...
                    <div class="w-full">
                        ...
                        <div class="grid mb-4 gap-2 w-full">
                            <div>
                                <div class="flex  w-full items-center mb-1">
                                    ...
                                    <div class="flex flex-row  w-full  gap-1">
                                        ...
                                        <input type="text" id="sugar_details" name="sugar_details" disabled
                                            class="block py-1 h-4.5 text-sm px-1 text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                            placeholder=" " />
                                    </div>
                                </div>
                                <div class="flex  w-full items-center mb-1">
            ...
            <main class="p-3 md:ml-64 h-auto pt-20" id="oralhealth" style="display: none; flex-direction: column;">
                <div class="text-center">
                    <p class="text-lg font-semibold  text-gray-900 dark:text-white">Oral Health Condition</p>
                </div>

                <section class="bg-white w-full dark:bg-gray-900 p-3 rounded-lg mb-3 mt-3">
                    <div class="flex flex-col w-full gap-2 mb-4">
                        ...
                        <div class="flex flex-row  gap-2 w-full">
                            <div class=" flex flex-col gap-2 w-full">
                                <div class="flex flex-row justify-between items-center ">
                                    <label for="name"
                                        class="text-sm font-medium text-gray-900 dark:text-white">Orally Fit Child
                                        (OFC):</label>
                                    <input type="text" name="ofc" id="ofc"
                                        class="bg-gray-50 border block border-gray-300 text-gray-900 text-center text-xs rounded-sm focus:ring-primary-600 focus:border-primary-600  p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        readonly onclick="toggleCheck(this)" placeholder="Click" />
                                </div>
                                <div class="flex flex-row justify-between items-center  ">
                                    <label for="name"
                                        class=" text-sm font-medium text-gray-900 dark:text-white">Dental
                                        Caries:</label>
                                    <input type="text" name="dental_caries" id="dental_caries"
                                        class="bg-gray-50 border border-gray-300 text-center text-gray-900 text-xs rounded-sm focus:ring-primary-600 focus:border-primary-600 block  p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        readonly onclick="toggleCheck(this)" placeholder="Click" />
                                </div>
                                <div class="flex flex-row justify-between items-center  ">
                                    <label for="name"
                                        class=" text-sm font-medium text-gray-900 dark:text-white">Gingivitis:</label>
                                ...
                                <div class="flex flex-row justify-between items-center  ">
                                    <label for="name"
                                        class=" text-sm font-medium text-gray-900 dark:text-white">Periodontal
                                        Disease:</label>
                                ...
                                <div class="flex flex-row w-full justify-between">
                                    <label for="name"
                                        class="text-sm font-medium  text-gray-900 dark:text-white">Others
                                        (supernumerary/<br>mesiodens,<br>malocclusions, etc.):</label>
                            ...
                            <div class=" flex flex-col gap-2 w-full">
                                <div class="flex flex-row justify-between items-center ">
                                    <label for="name"
                                        class=" text-sm font-medium text-gray-900 dark:text-white">Debris:</label>
                                ...
                                <div class="flex flex-row justify-between items-center ">
                                    <label for="name"
                                        class=" text-sm font-medium text-gray-900 dark:text-white">Calculus:</label>
                                ...
                                <div class="flex flex-row justify-between items-center ">
                                    <label for="name"
                                        class=" text-sm font-medium text-gray-900 dark:text-white">Abnormal
                                        Growth:</label>
                                ...
                                <div class="flex flex-row justify-between items-center ">
                                    <label for="name"
                                        class=" text-sm font-medium text-gray-900 dark:text-white">Cleft Lip /
                                        Palate:</label>
                        ...
                        <div class="flex flex-row  gap-2 w-full">
                            <div class="flex flex-col gap-2 w-full">
                                <div class="flex flex-row justify-between items-center ">
                                    <label for="name" class=" text-sm font-medium text-gray-900 dark:text-white">No.
                                        of Perm. Teeth Present:</label>
                                    <input type="text" name="perm_teeth_present" id="perm_teeth_present"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-sm focus:ring-primary-600 focus:border-primary-600 block  p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="" required="">
                                </div>
                                <div class="flex flex-row justify-between items-center ">
                                    <label for="name" class=" text-sm font-medium text-gray-900 dark:text-white">No.
                                ...
                                <div class="flex flex-row justify-between items-center ">
                                    <label for="name"
                                        class=" text-sm font-medium text-gray-900 dark:text-white">Total DMF
                                        Teeth:</label>
                            ...
                            <div class=" flex flex-col gap-2 w-full">
                                ...
                                <div class="flex flex-row justify-between items-center ">
                                    <label for="name"
                                        class=" text-sm font-medium text-gray-900 dark:text-white">Total df
                                        Teeth:</label>
            ...
            <main class="p-3 md:ml-64 h-auto pt-20" id="oralhealthA&B" style="display: none; flex-direction: column;">
                <div class="text-center">
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">Oral Health Condition</p>
                </div>

                <section class="bg-white dark:bg-gray-900 p-2 w-full rounded-lg mb-3 mt-3">
                    <!-- Set A -->
                    <div class="w-full">
                        <input type="hidden" id="visit_id" value="0">
                        <div class="mb-3">
                        ...
                        <div class="md:hidden mb-4">
                            ...
                            dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" id="undoBtnMobile">
                            ...
                            bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-blue-300 
                            font-medium rounded-lg text-sm p-1 w-20 
                            dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" id="redoBtnMobile">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <button type="button" class="text-white justify-center cursor-pointer inline-flex items-center gap-1
                        bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-blue-300 
                        font-medium rounded-lg text-sm p-1 w-full 
                        dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" id="clearAllMobile">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="flex flex-col w-full gap-2">
                                ...
                                <div class="flex flex-col w-full overflow-x-auto flex-grow">
                                    ...
                                    <p style="margin-bottom: -30px; margin-top: 3px;"
                                        class="text-sm ml-2 font-normal text-gray-900 dark:text-white">Condition</p>
                                    <div class="w-full min-w-max">
                                ...
                                <div class="controls relative w-full p-3 flex rounded-sm flex-col border border-dashed border-gray-400 [border-image:repeating-linear-gradient(45deg,#6b7280_0_10px,transparent_10px_15px)_1]">
                                    <div>
                                        ...
                                        <p class="text-sm font-normal text-gray-900 dark:text-white">Capital letters
                                            shall be used for recording the condition of permanent dentition and small letters
                                            for the status of temporary dentition.
                                        </p>
                                    </div>
                                    <div class="overflow-x-auto">
                                        <table class="w-full text-sm text-center border-1 min-w-max">
                                            <thead class="text-sm align-text-top text-gray-700 border">
                                                <tr>
                                                    <th scope="col" class="border-1 p-1">
                                                        Permanent <br> <input type="checkbox" id="upperCaseChk" checked>
                                                    </th>
                                                    <th scope="col" class="w-20 border-1 p-1">
                                                        Tooth Condition
                                                    </th>
                                                    <th scope="col" class="border-1 p-1">
                                            ...
                                            <tbody>
                                                <tr class="border-1">
                                                    <td class="border-1 p-1">✓</td>
                                                    <td class="border-1 p-1">Sound/Sealed</td>
                                                    <td class="border-1 p-1">✓</td>
                                                </tr>
                                                <tr class="border-1">
                                                    <td class="border-1 p-1">D</td>
                                                    <td class="border-1 p-1">Decayed</td>
                                                    <td class="border-1 p-1">d</td>
                                                </tr>
                                                <tr class="border-1">
                                                    <td class="border-1 p-1">F</td>
                                                    <td class="border-1 p-1">Filled</td>
                                                    <td class="border-1 p-1">f</td>
                                                </tr>
                                                <tr class="border-1">
                                                    <td class="border-1 p-1">M</td>
                                                    <td class="border-1 p-1">Missing</td>
                                                    <td class="border-1 p-1">m</td>
                                                </tr>
                                                <tr class="border-1">
                                                    <td class="border-1 p-1">DX</td>
                                                    <td class="p-1 border-1">Indicated for Extraction</td>
                                                    <td class="border-1 p-1">dx</td>
                                                </tr>
                                                <tr class="border-1">
                                                    <td class="border-1 p-1">Un</td>
                                                    <td class="border-1 p-1">Unerupted</td>
                                                    <td class="border-1 p-1">un</td>
                                                </tr>
                                                <tr class="border-1">
                                                    <td class="border-1 p-1">S</td>
                                                    <td class="border-1 p-1">Supernumerary Tooth</td>
                                                    <td class="border-1 p-1">s</td>
                                                </tr>
                                                <tr class="border-1">
                                                    <td class="border-1 p-1">JC</td>
                                                    <td class="border-1 p-1">Jacket Crown</td>
                                                    <td class="border-1 p-1">jc</td>
                                                </tr>
                                                <tr class="border-1">
                                                    <td class="border-1 p-1">P</td>
                                                    <td class="border-1 p-1">Pontic</td>
                                                    <td class="border-1 p-1">p</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <div class="flex flex-col sm:flex-row items-center w-full gap-2 mt-2">
                                        <label class="text-sm font-semibold w-full sm:w-auto text-gray-900 dark:text-white">Color Code:</label>
                                        <div class="flex flex-col sm:flex-row gap-2 w-full">
                                            <select id="blueSelect"
                                                class="text-white justify-center cursor-pointer inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm p-1.5 w-full sm:w-31.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            ...
                                            <select id="redSelect"
                                                class="text-white justify-center cursor-pointer inline-flex items-center bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-red-200 font-medium rounded-sm text-sm p-1.5 w-full sm:w-31.5 dark:bg-red-500 dark:hover:bg-red-700 dark:focus:ring-red-700">
                                ...
                                <div class="controls p-3 flex w-full lg:min-w-full rounded-sm flex-col border border-dashed border-gray-400 [border-image:repeating-linear-gradient(45deg,#6b7280_0_10px,transparent_10px_15px)_1]">
                                    <div class="w-full flex flex-col justify-center items-center">
                                        <div class="flex flex-col gap-3">
                                            <p class="text-sm font-medium text-gray-900 dark:text-white">Legend: <span
                                                    class="font-normal">Treatment</span>
                                            </p>
                                            <div class="flex flex-col gap-3">
                                                <p class="text-sm font-normal text-gray-900 dark:text-white">Topical Fluoride Application:</p>
                                                <p class="text-sm font-normal ml-5 text-gray-900 dark:text-white">FV - Fluoride Varnish</p>
                                                <p class="text-sm font-normal ml-5 text-gray-900 dark:text-white">FG - Fluoride Gel</p>
                                            </div>
                                            <p class="text-sm font-normal text-gray-900 dark:text-white">PFS - Pit and Fissure Sealant</p>
                                            <p class="text-sm font-normal text-gray-900 dark:text-white">PF - Permanent Filling (Composite, Am, ART)</p>
                                            <p class="text-sm font-normal text-gray-900 dark:text-white">TF - Temporary Filling</p>
                                            <p class="text-sm font-normal text-gray-900 dark:text-white">X - Extraction</p>
                                            <p class="text-sm font-normal text-gray-900 dark:text-white">O - Others</p>
                                        </div>
                                    </div>
                    ...
                    <div class="w-full mt-6">
                        <div class="mb-3">
                            <p class="text-14 font-semibold text-gray-900 dark:text-white">B. Services Monitoring Chart</p>
                        </div>
                        <div class="flex flex-col w-full justify-between items-center gap-4">
                            <!-- Top Teeth Section -->
                            <div class="w-full flex flex-col lg:flex-row gap-4">
                                <div class="w-full lg:w-160 flex flex-col">
                                ...
                                <!-- Legend and Treatment Selection - Stacked on mobile -->
                                <div class="flex flex-col gap-4 w-full lg:w-auto">
                                        ...
                                        <div class="w-full flex flex-col justify-center items-center">
                                            <div class="flex flex-col gap-0.5">
                                                ...
                                                <div class="flex flex-col gap-0.5 ml-5">
                                                    <p class="text-sm font-normal text-gray-900 dark:text-white">FV - Fluoride Varnish</p>
                                                    <p class="text-sm font-normal text-gray-900 dark:text-white">FG - Fluoride Gel</p>
                                                    <p class="text-sm font-normal text-gray-900 dark:text-white">PFS - Pit and Fissure Sealant</p>
                                                    <p class="text-sm font-normal text-gray-900 dark:text-white">PF - Permanent Filling (Composite, Am, ART)</p>
                                                    <p class="text-sm font-normal text-gray-900 dark:text-white">TF - Temporary Filling</p>
                                                    <p class="text-sm font-normal text-gray-900 dark:text-white">X - Extraction</p>
                                    ...
                                    <!-- Treatment Selection -->
                                    <div class="w-full lg:w-48 flex flex-col p-2">
            ...
            <main class="p-3 md:ml-64 h-auto pt-20" id="recofservoriented"
                style="display: none; flex-direction: column;">
                <div class="text-center">
                    <p class="text-lg font-semibold  text-gray-900 dark:text-white">Individual Patient Treatment Record
                    </p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            searchInput.addEventListener("input", async function() {
                ...
                try {
                    const res = await fetch(`/DentalEMR_System/php/treatment/patient_api.php?q=${encodeURIComponent(query)}`);
            ...
            async function fillPatientForm(patientId) {
                try {
                    const res = await fetch(`/DentalEMR_System/php/treatment/patient_api.php?id=${patientId}`);
                    const data = await res.json();
            ...
            async function savePatient() {
                ...
                try {
                    const res = await fetch("/DentalEMR_System/php/treatment/patient_api.php", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json"
                        },
