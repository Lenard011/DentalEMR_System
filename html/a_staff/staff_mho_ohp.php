...
<body class="bg-gray-50 dark:bg-gray-900">
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <aside
            ...
            <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
                ...
                <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <li>
                        <a href="#"
                            class="flex items-center p-2 text-base font-medium text-blue-600 bg-blue-100 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="flex-shrink-0 w-6 h-6 text-blue-500 transition duration-75 dark:text-blue-400  dark:group-hover:text-blue"
        ...
        <main class="p-3 md:ml-64 h-auto pt-20">
            <section class="bg-white dark:bg-gray-900 p-3 rounded-lg mb-3 mt-3">
                ...
                <div id="print-content">
                    <div class="overflow-x-auto">
                        <table class="text-xs text-gray-600 border dark:text-gray-300 border-gray-300 border-collapse w-full min-w-[2000px] text-center">
